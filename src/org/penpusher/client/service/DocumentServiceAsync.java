...
public interface DocumentServiceAsync {
    ...
    void addDocument(String filename, String description, Form form, Folder folder, AsyncCallback<String> callback);

    void removeDocument(String filename, Folder folder, AsyncCallback<Void> callback);

    void listDocuments(Folder folder, AsyncCallback<List<DocumentDescriptor>> callback);
}
